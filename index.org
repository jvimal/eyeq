...
#+STYLE: <style> p { text-align: left; line-height: 1.2em; font-size: 1.2em; } li {padding-bottom: 0.2em;}</style>
...
#+STYLE: h3, h4, h5, h6 {border-bottom: 1px solid #ccc; color: blue; background-color: #fff; }</style>
#+OPTIONS: _:nil
